...
if game.CoreGui:FindFirstChild("GGENJ0Y") then
    game.CoreGui:FindFirstChild("GGENJ0Y"):Destroy()
end
...
do
    ...
    function Funcs:AddLabel(Text, Mid)
        ...
        function Label:FuckingSetText(Text)
...
function Library:CreateWindow(WindowTitle)
    ...
    local Outer = Library:Create('Frame', {
        ...
        BorderSizePixel = 0;
        Position = UDim2.new(0.5, -275, 0.5, -275);
    ...
    function Window:SetWindowTitle(Title)
        ...
        function Window:AddRightTabbox(Name)
...
local Window = Library:CreateWindow(os.date("Jinny - 5G The Augmented Of Reality"))
local Home = Window:AddTab("Main")
local Settings = Window:AddTab("Settings")
task.spawn(function()
    while task.wait() do
        pcall(function()
            Window:SetWindowTitle("Jinny - 5G The Augmented Of Reality | "..os.date("%H:%M:%S %p"))
        end)
    end
end)
local SetZ = Home:AddCenterGroupBox('[ Settings ]')
local MainZ = Home:AddCenterGroupBox('[ Main ]')
local ESPZZZ = Home:AddCenterGroupBox('[ ESP ]')
local MisZZZ = Home:AddCenterGroupBox('[ Misc ]')

SetZ:AddDropdown('SSS2', {Values = {"HumanoidRootPart","Head","UpperTorso","LowerTorso"}, Default = 1, Multi = false, Text = 'Mobs', Tooltip = ''})

Options.SSS2:OnChanged(function(State)
    AimPart = Options.SSS2.Value
end)

SetZ:AddSlider('Addr', {Text = 'AimBot FOV',Default = 250,Min = 0,Max = 1000,Rounding = 1,Compact = false,})
Options.Addr:OnChanged(function()
    Aimbot.FOV = Options.Addr.Value   
end)

SetZ:AddLabel('Color'):AddColorPicker('ColorPicker', {Default = Color3.new(0, 1, 0),Title = 'FOV Color'})
...
MainZ:AddToggle('A', {Text = 'Enabled Aimbot', Default = false,Tooltip = ''})
Toggles.A:OnChanged(function(State)
    Aimbot.Enabled = Toggles.A.Value
end)
MainZ:AddToggle('V', {Text = 'Aimbot Wall', Default = false,Tooltip = ''})
Toggles.V:OnChanged(function(State)
    Aimbot.WallCheck = Toggles.V.Value
end)

MainZ:AddToggle('cS', {Text = ' AimBot Free For All', Default = false,Tooltip = ''})
Toggles.cS:OnChanged(function(State)
    Aimbot.FreeForAll = Toggles.cS.Value
    T.TeamCheck = Aimbot.FreeForAll
end)

MainZ:AddToggle('SSS', {Text = 'Aimbot FOV Visible', Default = false,Tooltip = ''})
Toggles.SSS:OnChanged(function(State)
    Circle.Visible = Toggles.SSS.Value
end)

MainZ:AddToggle('VS', {Text = 'Slient Aim', Default = false,Tooltip = ''})
...
ESPZZZ:AddToggle('ESP1', {Text = 'Esp Toggle', Default = false,Tooltip = ''})
Toggles.ESP1:OnChanged(function(State)
ESP:Toggle(Toggles.ESP1.Value)
end)

ESPZZZ:AddToggle('ESP2', {Text = 'Esp Players', Default = false,Tooltip = ''})
Toggles.ESP2:OnChanged(function(State)
ESP.Players = Toggles.ESP2.Value
end)

ESPZZZ:AddToggle('ESP3', {Text = 'Esp Tracers', Default = false,Tooltip = ''})
Toggles.ESP3:OnChanged(function(State)
ESP.Tracers = Toggles.ESP3.Value
end)

ESPZZZ:AddToggle('ESP4', {Text = 'Esp Names', Default = false,Tooltip = ''})
Toggles.ESP4:OnChanged(function(State)
ESP.EspNames = Toggles.ESP4.Value
end)

ESPZZZ:AddToggle('ESP5', {Text = 'Esp Boxes', Default = false,Tooltip = ''})
Toggles.ESP5:OnChanged(function(State)
ESP.Boxes = Toggles.ESP5.Value
end)

MisZZZ:AddToggle('BHOP', {Text = 'B Hop', Default = false,Tooltip = ''})
...
MisZZZ:AddToggle('BHOPs', {Text = 'RainBowGun', Default = false,Tooltip = ''})
...
MisZZZ:AddToggle('d', {Text = 'Auto Heal', Default = false,Tooltip = ''})
...
MisZZZ:AddToggle('Bs', {Text = 'Infinite Ammo', Default = false,Tooltip = ''})
...
MisZZZ:AddToggle('Bs1', {Text = 'Fast Firerate', Default = false,Tooltip = ''})
...
MisZZZ:AddToggle('Bs4', {Text = 'No recoil', Default = false,Tooltip = ''})
...
MisZZZ:AddToggle('SSS', {Text = 'Infinite Jump',Default =  InfiniteJump,Tooltip = '', 
})
Toggles.SSS:OnChanged(function(State)
InfiniteJump = State
...
MisZZZ:AddToggle('SSS', {Text = 'N NoClip',Default =  Sex2,Tooltip = ''})
Toggles.SSS:OnChanged(function(State)
    Sex2 = State
...
MisZZZ:AddToggle('SSS', {Text = 'H Fly',Default =  Sex,Tooltip = 'Fly By Pressing H'})
Toggles.SSS:OnChanged(function(State)
Sex = State
...
MisZZZ:AddButton('ServerHop', function() ServerHop() end)
MisZZZ:AddButton('Rejoin', function() 
