...
if game.CoreGui:FindFirstChild("Linoria-UI") then
    game.CoreGui:FindFirstChild("Linoria-UI"):Destroy()
end
ScreenGui.Name = "Linoria-UI"
local Toggles = {};
local Options = {};
...
local Library = {
    ...
    AccentColor = Color3.fromRGB(0, 255, 229);
